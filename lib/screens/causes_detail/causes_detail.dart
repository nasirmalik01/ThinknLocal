                                        ...
                                        children: [
                                          ...
                                          _causesDetailController
                                              ...
                                              ? Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Padding(padding: EdgeInsets.symmetric(horizontal: sizes.width * 0.06),
                                                      child: TextView
                                                          .titleWithDecoration(
                                                              Strings
                                                                  .featuredSponsors,
                                                                      ...
                                                                      return GestureDetector(
                                                                        onTap: () {
                                                                          customDialog(
                                                                              ...
                                                                              summary: '(${_causesDetailController.causeFeaturedList![index].phone!.substring(0,3)}) ${_causesDetailController.causeFeaturedList![index].phone!.substring(3, 6)}-${_causesDetailController.causeFeaturedList![index].phone!.substring(6, )}',

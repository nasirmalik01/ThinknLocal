...
class CauseDetailComponents {
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border(
                    bottom: BorderSide(
              color:
                  isSelected ? AppColors.greenColor : AppColors.pureWhiteColor,
              width: sizes.width * 0.005,
            ))),
            child: TextView.headerWithBlurRadius(title,
  ...
  Widget statsGraphBottomTitles(double value, TitleMeta meta) {
    ...
    return Center(
        child: TextView.subHeader(text,
            color: AppColors.pureBlack, fontFamily: Assets.poppinsRegular));
  }
  ...
  Widget statsGraphLeftTitles(double value, TitleMeta meta) {
    ...
    return Padding(
      child: TextView.subHeader(meta.formattedValue,
          color: AppColors.pureBlack, fontFamily: Assets.poppinsRegular),

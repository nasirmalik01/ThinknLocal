...
import 'package:thinknlocal_app/screens/about_visit/auto_complete_text_field.dart';
...
class AboutVisit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(
        () => (_aboutVisitController.isBusinessLoading.value ||
                _aboutVisitController.isCausesLoading.value)
            ? bouncingLoadingIndicator()
            : _contributionController.isUploading.value
                ? const Uploading()
                : _contributionController.isUploadSuccess.value
                    ? const UploadSuccess()
                    : _contributionController.isUploadFailed.value
                        ? UploadFailed(
                            onTryAgainClick: () {
                              Map<String, dynamic> body = {};
                              body['business_id'] = _aboutVisitController
                                  .selectedBusinessId.value;
                              body['cause_id'] =
                                  _aboutVisitController.selectedCauseId.value;
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        AutoFieldTextField(
                                          ...
                                          onSelect: _aboutVisitController
                                              .onBusinessCompletePress,
                                          isBusiness: true,
                                        ),
                                        SizedBox(
                                          height: getHeight() * 0.04,
                                        ...
                                        AutoFieldTextField(
                                          ...
                                          onSelect: _aboutVisitController
                                              .onCauseCompletePress,
                                          isEnabled: _aboutVisitController
                                                      .selectedBusinessId
                                                      .value ==
                                                  0
                                              ? false

...
List<Businesses> recentlyFundedBusinessList = [
  Businesses(title: 'Chino Hills High School Girls Softball Fundraiser', endDate: 'Mar 2nd', totalAmount: '450', raisedAmount: '342.61', backgroundImage: Assets.recentlyStarted1, icon: Assets.dummyLogo, color: [Colors.transparent, AppColors.greenColor,],),
  Businesses(title: 'Chino Hills High School Girls Softball Fundraiser', endDate: 'Mar 2nd', totalAmount: '450', raisedAmount: '342.61', backgroundImage: Assets.recentlyStarted2, icon: Assets.dummyLogo, color: [Colors.transparent, AppColors.lightPurpleColor,],),
  Businesses(title: 'Chino Hills High School Girls Softball Fundraiser', endDate: 'Mar 2nd', totalAmount: '450', raisedAmount: '342.61', backgroundImage: Assets.recentlyStarted3, icon: Assets.dummyLogo, color: [Colors.transparent, AppColors.lightOrangeColor,],),
];